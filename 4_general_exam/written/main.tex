...
\subfile{Sections/3_task_innovation}

\section{Research Plan}
\label{sec:research_plan}
\subfile{Sections/4_research_plan_aim1}
\subfile{Sections/4_research_plan_aim2}
\subfile{Sections/4_research_plan_aim3}

\section{Study Limitations and Future Work}
\label{sec:limitations}
\subfile{Sections/5_limitations}

\section{Timeline and Summary}
\label{sec:timeline}
\subfile{Sections/6_timeline}

\section{Acknowledgements}
\label{sec:acknowledgements}
\subfile{Sections/7_acknowledgements}
