...
\begin{figure}[h]
  \includegraphics[scale=0.57]{Figures/6_query_generation/leafai_architecture.pdf}  
...
\begin{figure}[h]
  \includegraphics[scale=0.46]{Figures/6_query_generation/leafai_flow.pdf}  
...
\begin{figure}[h!]
  \includegraphics[scale=0.47]{Figures/6_query_generation/leafai_smm.pdf}  
...
\begin{table}[h!]
    \small
    \centering
    \input{Tables/6_query_generation/results}
...
\begin{table}[h!]
    \footnotesize
    \centering
    \input{Tables/6_query_generation/results_skipped}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[scale=0.54]{Figures/6_query_generation/leafai_analysis.pdf}  
  \end{center}
